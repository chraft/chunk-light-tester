...
namespace CustomGenerator
{
    public class CustomChunkGenerator
    {
        ...
        public Chunk GenerateChunk(Chunk chunk, int x, int z)
        {
        ...
        private void GenerateTerrain(Chunk c, int x, int z)
        {           
        ...
        private void GenerateResource(int x, int y, int z, Chunk c)
        {
        ...
        private void GenerateFlora(Chunk c, int x, int z)
        {
        ...
        private bool CanSeeTheSky(int x, int y, int z, Chunk c)
        {
            int by;
            for (by = y; c.GetType(x,y,z) == 0 && by < 128; ++by) ;
        ...
        private void GenerateOuterLayer(int x, int y, int z, int firstBlockHeight, BIOME_TYPE type, Chunk c)
        {
